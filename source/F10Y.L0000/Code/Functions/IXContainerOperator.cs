...
#pragma warning restore IDE1006 // Naming Styles
        ...
        /// </summary>
        IEnumerable<XElement> Enumerate_Children(XContainer container)
            => container.Elements();

        /// <summary>
        /// A better named quality-of-life method for <see cref="XContainer.Elements()"/>.
        /// </summary>
        IEnumerable<XElement> Enumerate_Children(
            XContainer container,
            string childName)
        ...
        IEnumerable<XElement> Enumerate_ChildrenOfChildren(XContainer container)
            => this.Enumerate_Children(container)
                .SelectMany(this.Enumerate_Children)
                ;

        IEnumerable<XElement> Enumerate_ChildrenOfChildren(
            XContainer container,
            string childOfChildName)
        ...
        /// A better named quality-of-life method for <see cref="XContainer.Elements()"/>.
        /// </summary>
        XElement[] Get_Children(XContainer container)
            => this.Enumerate_Children(container)
                .Now();

        bool Remove_Child_First(
            XContainer container,
            string childName,
        ...
        bool Has_ChildOfChild_Value_First<TValue>(
            XContainer container,
            string childOfChildName,
            out TValue value_OrDefault,
            Func<XElement, TValue> valueSelector)
        ...
        bool Has_ChildOfChild_Value_First(
            XContainer container,
            string childOfChildName,
            out string value_OrDefault)
        ...
        bool Has_ChildWithAttributeValue_First(
            XContainer container,
