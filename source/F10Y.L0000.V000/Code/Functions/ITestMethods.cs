...
namespace F10Y.L0000.V000
{
    ...
    public partial interface ITestMethods
    {
        ...
        void Ensure_Enquoted_All(Ensure_Enquoted ensure_Enquoted)
        ...
        void Ensure_Enquoted_Neither(Ensure_Enquoted ensure_Enquoted)
            => Instances.TestOperator.Test_Function(
                ensure_Enquoted,
                Instances.Expectations.For_Ensure_Enquoted);

        /// <inheritdoc cref="Raw.IExpectations.N_004"/>
        void Ensure_Enquoted_Both(Ensure_Enquoted ensure_Enquoted)
            => Instances.TestOperator.Test_Function(
                ensure_Enquoted,
                Instances.Expectations._Raw.N_004);

        /// <inheritdoc cref="Raw.IExpectations.N_002"/>
        void Ensure_Enquoted_Beginning(Ensure_Enquoted ensure_Enquoted)
            => Instances.TestOperator.Test_Function(
                ensure_Enquoted,
                Instances.Expectations._Raw.N_002);

        /// <inheritdoc cref="Raw.IExpectations.N_003"/>
        void Ensure_Enquoted_Ending(Ensure_Enquoted ensure_Enquoted)
            => Instances.TestOperator.Test_Function(
                ensure_Enquoted,
