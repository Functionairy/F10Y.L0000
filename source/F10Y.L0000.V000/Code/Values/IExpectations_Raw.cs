...
namespace F10Y.L0000.V000.Raw
{
    ...
    public partial interface IExpectations
    {
        ...
        /// </summary>
        ExpectationTypes.IExpectation<string, string> N_001 => Instances.ExpectationOperator.From(
        ...
        /// </summary>
        ExpectationTypes.IExpectation<string, string> N_002 => Instances.ExpectationOperator.From(
        ...
        /// </summary>
        ExpectationTypes.IExpectation<string, string> N_003 => Instances.ExpectationOperator.From(
        ...
        /// </summary>
        ExpectationTypes.IExpectation<string, string> N_004 => Instances.ExpectationOperator.From(
            Instances.Texts.Example_Text_Enquoted,
            Instances.Texts.Example_Text_Enquoted);
    }
}
